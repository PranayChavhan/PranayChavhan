...
- **Node.js** ⚡ and **Express.js** 🌐: I have hands-on experience with Node.js and Express.js, leveraging their speed and efficiency for server-side development. I enjoy building RESTful APIs and working with real-time data through socket APIs and WebSockets.
...
Currently, I'm diving into the exciting world of **MERN** (MongoDB, Express.js, React.js, Node.js) stack. This technology stack allows me to build robust and full-featured web applications. I'm exploring the intricacies of these technologies and incorporating them into my skill set to expand my capabilities as a developer.

Moreover, I have a strong interest in the field of **Artificial Intelligence (AI)** and **Machine Learning (ML)**. I am currently learning about AI algorithms and exploring frameworks like **TensorFlow** and **Keras**. I recently completed a project called "**SignSense**," which involved building a web application for sign language recognition using neural networks and MediaPipe. It was an incredible experience, and I am excited to continue exploring the possibilities of AI and ML in my future projects. 🤖
